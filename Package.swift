...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "LASDKiOS", url: "https://swift-sdk.s3.us-east-2.amazonaws.com/lasdk/LASDKiOS-2.0.0.xcframework.zip", checksum: "2252ce86ee219be44fc74eecdaf3f04bcc7fd3cd1fae304116d2bb5105a8202f"),
