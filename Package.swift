...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "LASDKiOS", url: "https://swift-sdk.s3.us-east-2.amazonaws.com/lasdk/LASDKiOS-2.0.0.xcframework.zip", checksum: "163c724f58cabef4d8be61aa7dfc835f54931f0a522db66a6006b849b249265b"),
